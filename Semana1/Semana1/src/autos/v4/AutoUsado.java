...
public abstract class AutoUsado implements AutoEnVenta {
	...
	public AutoUsado(double precio, String marca, String tipovehiculo, int numerocilindros, double kilometraje,
